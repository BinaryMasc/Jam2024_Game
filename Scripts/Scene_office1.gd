...
func _on_hands_pressed():
	if not hands_pressed:
		...
		sub_controller.new_subtitle("Jefe", "¡¿QUÉ QUIERES?!")
		hands_pressed = true
	else: 
		...
		sub_controller.new_subtitle("Jefe", "NO COMO OTROS.")
...
func _on_choose_question_2_flow_1():
	...
	sub_controller.new_subtitle("Freddy", "¡Suerte!")
...
func _on_choose_question_2_flow_2():
	...
	sub_controller.new_subtitle("Freddy", "Gracias.")
